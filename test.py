import unittest
from main import add, subtract, multiply, divide, remainder_divide
...
class TestMath(unittest.TestCase):
   ...
   def test_remainder_divide(self):
       self.assertNotEqual(remainder_divide(4, 2), 1)
       self.assertEqual(remainder_divide(20.0, 5.0), 0.0)
